   ...
   public function excel(Request $request)
	{
	    ...
	    $PersonalDetailArray[] = [
		            ...
		            'old_house_number'=>'Old House', 
		            'old_house_owner_name'=>'Old House Name', 
		            'old_house_father_name'=>'Old House Father', 
		             'name'=>'Owner Name',
	    ...
	    foreach ($result as $value) {
	        ...
	        $PersonalDetailArray[] =array(
	        	...
	        	'old_house_owner_name'=>$value->old_house_owner_name,
	        	'old_house_father_name'=>$value->old_house_father_name,
	        	'name'=>$value->name,
	   ...
	   //dd($PersonalDetailArray);
	    // Generate and return the spreadsheet
	    Excel::create('PersonalDetailSurveyStatus', function($excel) use ($PersonalDetailArray) {

	        // Set the spreadsheet title, creator, and description
	        $excel->setTitle('PersonalDetailSurveyStatus');
	        $excel->setCreator('Laravel')->setCompany('WJ Gilmore, LLC');
	        $excel->setDescription('PersonalDetailSurveyStatus file');

	        // Build the spreadsheet, passing in the payments array
	        $excel->sheet('sheet1', function($sheet) use ($PersonalDetailArray) {
	            $sheet->fromArray($PersonalDetailArray, null, 'A1', false, false);
	        });
