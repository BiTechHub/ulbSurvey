...
class AesForJavaSend {
    ...
    public function setMode($mode) {
        switch ($mode) {
            case AesForJavaSend::M_CBC:
                $this->mode = "MCRYPT_MODE_CBC";
                break;
            case AesForJavaSend::M_CFB:
                $this->mode = "MCRYPT_MODE_CFB";
                break;
            case AesForJavaSend::M_ECB:
                $this->mode = "MCRYPT_MODE_ECB";
                break;
            case AesForJavaSend::M_NOFB:
                $this->mode = "MCRYPT_MODE_NOFB";
                break;
            case AesForJavaSend::M_OFB:
                $this->mode = "MCRYPT_MODE_OFB";
                break;
            case AesForJavaSend::M_STREAM:
