...
<div class="dashboard-main-body">
  ...
  <h6 class="font-semibold mb-0 dark:text-white">Survey Step 1 Verified</h6>
  <ul class="flex items-center gap-[6px]">
    ...
    <li class="font-medium dark:text-white">Survey Step 1 Verified</li>
  </ul>
</div>
                ...
                <form method="post" action="{{ url('/') }}/Search-Survey-Details-List">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
                        ...
                        <div class="flex justify-end">
                            <div class="flex w-full md:w-2/3 lg:w-1/2">
                                <a href="{{ url('/') }}/Add-New-House" class="btn btn-info float-end">Add House</a>
                            </div>
                        </div>
                        @endif
                    </div>
