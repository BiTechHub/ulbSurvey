...
<div class="dashboard-main-body">
  ...
  <h6 class="font-semibold mb-0 dark:text-white">Personal Details Verified</h6>
  <ul class="flex items-center gap-[6px]">
    ...
    <li class="font-medium dark:text-white">Personal Details Verified</li>
  </ul>
</div>
            ...
            <div class="table-responsive scroll-sm">
              <table class="table bordered-table mb-0">
                        <thead>
								...
								<tbody id="searchData">
									@foreach($Personaldata as $index=>$value)
									<tr>
										<td>
										@if($user_access[0]->fn_update=='Y')
										<a target="_BLANK" class="label label-primary" href="{{url('/')}}/UpdateDetails?id={{$value->survey_id}}" >{{($Personaldata->currentpage()-1) * $Personaldata->perpage() + $index + 1 }}</a>
										...
										@else
											{{($Personaldata->currentpage()-1) * $Personaldata->perpage() + $index + 1 }}
										@endif
										</td>
