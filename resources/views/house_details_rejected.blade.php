			...
			<!--CONTENT CONTAINER-->
				...
				<div id="content-container">
					...
					<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
					<div id="page-title">
						<h1 class="page-header text-overflow">Rejected House Details</h1>
						...
						<div class="panel-body">
						  <div class="table-responsive">
							<table class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
									@foreach($rejected_house_details as $index=>$value)
									<tr>
										<td>{{($rejected_house_details->currentpage()-1) * $rejected_house_details->perpage() + $index + 1 }}</td>
