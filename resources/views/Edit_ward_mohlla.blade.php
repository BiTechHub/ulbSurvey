      ...
      <div class="col-span-12">
        <div class="card border-0">
          ...
          <div class="card-body" id="">
            ...
            @endif
            <form method="post" action="{{ route('update.WardDetail') }}" class="grid grid-cols-12 gap-4">
                @csrf
                @if ($errors->any())
              ...
              <div class="lg:col-span-3 col-span-12">
                ...
                <div class="flex">
                  <input type="text" name="wardnam" class="form-control" id="wardnam" value="{{ $wardl_data[0]->ward_name }}" required>
                  <input type="hidden" name="id" class="form-control" id="id" value="{{ $wardl_data[0]->id }}">
                </div>
              </div>
              <div class="lg:col-span-3 col-span-12">
                <label class="form-label">Mohalla </label>
                <div class="flex">
                  <input type="text" name="mohlla" class="form-control" id="mohlla" value="{{ $wardl_data[0]->mohalla_name }}" required>
                </div>
              </div>
