...
.custom-map-control-button{
  ...
  <h6 class="font-semibold mb-0 dark:text-white">Rejected Personal Details</h6>
  <ul class="flex items-center gap-[6px]">
    ...
    <li class="font-medium dark:text-white">Rejected Personal Details</li>
  </ul>
</div>
      ...
      <div class="col-span-12">
       @if(session('message'))
        ...
        <div class="card border-0">
         ...
         <form method="GET" action="{{ route('rejected.house.list') }}" class="row g-3 mb-3">
                        ...
                        <tbody>
                            @foreach($houses as $index => $value)
                                <tr>
                                    ...
                                    <td style="color:red">{{ $value->DataVerfied }}</td>
                                    <td><a href="{{url('/')}}/EditNewHouse/{{ $value->id }}" class="btn btn-primary">Edit</a></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
