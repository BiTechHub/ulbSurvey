                           ...
                           <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                               ...
                               <tbody>
                                   @foreach ($assets_detail_not_varify as $index => $value)
                                       <tr>
                                           <td>{{ ($assets_detail_not_varify->currentpage() - 1) * $assets_detail_not_varify->perpage() + $index + 1 }}
                                           </td>
                                           ...
                                           <td><a class="label label-primary" href="#" data-target="#demo-default-modal"
                                                   data-toggle="modal"
                                                   onclick="showImage('{{ url('/') }}/new_gis/upload/assets/{{ $value->photo }}','{{ $value->id }}')">View</a>
                                               <a class="label label-primary" href="#" data-target="#map-default-modal"
                                                   data-toggle="modal"
                                               ...
                                               @if ($user_access[0]->fn_update == 'Y')
                                                   <a class="label label-success"
                                                       href="{{ url('/') }}/Upadte-Assets-Details-NonVerified-List?id={{ $value->id }}">Edit</a>
                                               @endif
                                           </td>
