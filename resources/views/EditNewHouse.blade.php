...
.custom-map-control-button{
  ...
  <h6 class="font-semibold mb-0 dark:text-white">Edit New House</h6>
  <ul class="flex items-center gap-[6px]">
    ...
    <li class="font-medium dark:text-white">Edit New House</li>
  </ul>
</div>
             ...
             <!-- <div class="lg:col-span-3 col-span-12">
                ...
                <div class="flex">
                  <select class="form-control" name="house_no">
                    <option selected value="">Select House Number</option>
              ...
              <div class="lg:col-span-3 col-span-12">
                ...
                <div class="flex">
                  <select class="form-control" name="floor">
                    ...
                    <option selected value="{{$surveyHouse->no_of_floor}}">{{$surveyHouse->no_of_floor}}</option>
                    <option value="1">1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
                    <option value="4">4</option>
              ...
              <div class="lg:col-span-3 col-span-12">
                ...
                <div class="flex">
                  <select class="form-control" name="basement">
                    ...
                    <option selected value="{{$surveyHouse->basement}}">{{$surveyHouse->basement}}</option>
              ...
              <div class="lg:col-span-3 col-span-12">
                ...
                <div class="flex">
                  <select class="form-control" name="house_type">
                    ...
                    <option selected value="{{$surveyHouse->house_type}}">{{$surveyHouse->house_type}}</option>
